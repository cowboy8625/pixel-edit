...
pub const DELETE_ICON = @embedFile("assets/delete-icon.png");
...
pub const PLUS_ICON = @embedFile("assets/plus-icon.png");
...
pub const STOP_ICON = @embedFile("assets/stop-icon.png");
